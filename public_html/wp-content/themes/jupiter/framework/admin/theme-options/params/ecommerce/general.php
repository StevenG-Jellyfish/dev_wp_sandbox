...
$ecommerce_section[] = array(
    ...
    "fields" => array(
        ...
        array(
            ...
            "desc" => __("Show product category / tag name as page title on product category / tag page.", "mk_framework") ,
        ...
        array(
            ...
            "desc" => __("Show product category / tag as filter label for products on product category / tag page.", "mk_framework") ,
        ...
        array(
            ...
            "desc" => __("Show product name as page title in single product page.", "mk_framework") ,
        ...
        array(
            ...
            "desc" => __("You can enable/disable the Love Button in products loop.", "mk_framework") ,
