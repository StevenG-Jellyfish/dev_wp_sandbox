...
$typography_section[] = array(
    ...
    array(
        ...
        array(
            "name"    => __( 'Top Level Menu Items Text Size', 'mk_framework' ),
        ...
        array(
            "name"    => __( 'Top Level Menu Items Text Weight', 'mk_framework' ),
            "id"      => "dash_top_menu_text_weight",
            "default" => 600,
            "type"    => "font_weight"
        ),
        array(
            "name"    => __( 'Top Level Menu Items Text Case', 'mk_framework' ),
        ...
        array(
            "name"    => __( 'Sub Level Menu Items Text Size', 'mk_framework' ),
        ...
        array(
            "name"    => __( 'Sub Level Menu Items Text Weight', 'mk_framework' ),
            "id"      => "dash_sub_menu_text_weight",
            "default" => 400,
            "type"    => "font_weight"
        ),
        array(
            "name"    => __( 'Sub Level Menu Items Text Case', 'mk_framework' ),
